  ...
  <div class="span12">
    <div class="portlet box purple">
      <div class="portlet-title">
        <div class="caption">
          <i class="icon-reorder"></i>编辑分类</div>
      ...
      <div class="portlet-body form">
        ...
        @endif
        <!-- BEGIN FORM-->
        <form action="{{route('admin.category.update',['id'=>$items->id])}}" method="post" class="form-horizontal">
		   ...
		   <div class="control-group">
				...
				<div class="controls">
					...
					<input type="text" name="catename" value="{{$items->catename}}" class="span6 m-wrap">
