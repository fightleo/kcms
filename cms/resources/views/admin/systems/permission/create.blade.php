				...
				<form action="#" id="form_sample_1" class="form-horizontal" novalidate="novalidate">
					<div class="control-group">
						...
						<!-- 	<div class="select2-container span6 select2" id="s2id_select2_sample1">
							<a href="javascript:void(0)" onclick="return false;" class="select2-choice select2-default" tabindex="-1">   <span>请选择...</span><abbr class="select2-search-choice-close" style="display: none;"></abbr>   <div><b></b></div></a><input class="select2-focusser select2-offscreen" type="text" id="s2id_autogen1"></div> -->
							<select id="select2_sample1" class="span6 select2" tabindex="-1" name="username">
								
								<option value="">请选择...</option>
								@foreach($list as $items)
								<option value="AL">{{$items->username}}</option>
