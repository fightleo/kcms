...
<body class="login">
	...
	<div class="logo">
		...
		<img src="{{asset('media/image/logo-big.png')}}" alt="" /> 
	...
	<div class="content">
		...
		<form class="form-vertical login-form" action="{{route('admin.login.docheck')}}" method="post">

			<h3 class="form-title">登陆帐户</h3>
			...
			<div class="forget-password">
				...
				<p>
					...
					别担心, 点击 <a href="javascript:;" class="" id="forget-password">这</a>
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<div class="input-icon left">
						...
						<input class="m-wrap placeholder-no-fix" type="password" placeholder="重新输入您的密码" name="rpassword"/>
